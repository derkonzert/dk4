...
export function body(content) {
  return `<!DOCTYPE html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"/><style>${globalStyles()}</style></head><body>${content}</body></html>`;
}
